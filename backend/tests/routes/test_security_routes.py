...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("GET", "/v1/plaza/cards/card1/comments", None),
        ("POST", "/v1/plaza/like", {"cardId": "card1", "action": "like"}),
        ("POST", "/v1/plaza/cards/card1/comments", {"content": "hi"}),
        ("DELETE", "/v1/plaza/comments/c1", None),
        ("POST", "/v1/plaza/comments/c1/reports", {"reasonCode": "abuse"}),
